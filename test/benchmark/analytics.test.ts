...
describe("Analytics", function () {
	describe(".reduceUncertainty()", function () {
		let smallestMeasure: number;
		let fraction: number;
		let result: number;

		it("should return the correct uncertainty", function () {
			smallestMeasure = 20;
			fraction = 0.05;
	...
	describe(".getFullAnalysis()", function () {
		it("should return a full analysis", function () {
			const samples = Array(1000).fill(1).map((v, i) => (Math.sin(i) * Math.tan(i)) ** 2);
	...
	describe(".getMode()", function () {
		it("should return the most common number", function () {
		...
		it("should round the numbers and return the most common one", function () {
	...
	describe(".getMedian()", function () {
		it("should return the number in the middle of the ordered array", function () {
		...
		it("should return the average of the two numbers in the middle of the ordered array", function () {
